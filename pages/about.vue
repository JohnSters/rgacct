<template>
  <v-container>
    ...
    <p>If you’re in business as a sole trader or in a partnership, knowing how much tax you
      ...
      Let us assist to relieve you of the administrative burden:</p>
    <ul>
      <li>Preparation of business income tax computations</li>
      <li>Income tax planning</li>
      <li>Annual financial Statements and submitting Tax returns.</li>
      <li>Business planning to maintain better cash flow.</li>
    ...
    <ul>
      <li>Assistance with Customs registration</li>
      <li>Assistance with VAT registration / Diesel Rebate registration</li>
      <li>VAT control and reconciliation</li>
      <li>Monthly processing of VAT and assist in planning to ensure your cash flow</li>
    ...
    <ul>
      <li>Filing annual returns and accounts</li>
      <li>Maintenance of statutory changes</li>
    ...
    <p>Bookkeeping and payroll can be one of the most efficient ways of freeing up more
      ...
      bookkeeping needs. Let us assist you to give you more time to do what you enjoy.</p>
    <p>Our services include:</p>
    <ul>
      <li>Processing the weekly/monthly payroll on time EMP201</li>
      <li>Annual preparation of year end Employer Returns EMP501</li>
      <li>Compensation fund returns yearly.</li>
    </ul>

    <v-btn class="mt-8 green--text">Need Help? Contact us Today!</v-btn>
  </v-container>
</template>
